 ...
 */
public final class MyLogger extends ExtendedLoggerWrapper {
    private static final long serialVersionUID = 7491603554974L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = MyLogger.class.getName();
    private static final Level info = Level.forName("info", 1);
    private static final Level debug = Level.forName("debug", 1);
    private static final Level error = Level.forName("error", 1);
